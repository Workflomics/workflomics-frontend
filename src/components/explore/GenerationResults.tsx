      ...
      <div className="rating">
        {benchmark.steps.map((step, i) => [
          <span
            ...
            data-tip={step.label}
            style={{ backgroundColor: mapValueToColor(step.desirability) }}
          >
            {" "}
          </span>,
                        ...
                        <li key={index}>
                          <div className="flex items-center space-x-2">
                            <input
                              ...
                              onChange={(event) => {
                                handleSelected(workflow, event.target.checked);
                              }}
                            />
                            ...
                            <button
                              ...
                              onClick={() =>
                                downloadFile(workflow.run_id, workflow.cwl_name)
                              }
                            >
                              CWL
                            </button>
                      ...
                      {workflowSolutions
                        ...
                        .map((workflow: WorkflowSolution, index: number) => (
                          <div key={index} className="flip-card">
                            <div
                              className={`border-2 border-red-200 rounded-xl p-2 shadow-lg flip-card-inner ${doShowTechBenchmarks ? "is-flipped" : ""}`}
                            >
