  ...
  return (
    <div>
      <div className="flex space-x-7 p-11 justify-center">
        ...
        <HomeBox label="Generate Workflow Alternatives" descr="Upload a CWL workflow and explore alternative tool compositions using APE synthesis" imgUrl={benchmark_img} buttonText="Alternatives" isEnabled={true} component="/generate-alternatives" />
