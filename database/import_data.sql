INSERT INTO public."domain" (id,unique_label,repo_url,tool_annotations_file_name,ontology_file_name,docker_image_url,public) VALUES
	 ...
	 (2,'matabolomics','https://github.com/sanctuuary/APE_UseCases/tree/dev/Metabolomics','tool_annotations.json','edam.owl',NULL,true);
INSERT INTO public.doman_topics (domain_id,topic_id) VALUES
	 (1,3),
	 (1,4),
	 (1,6),
	 (2,4),
...
INSERT INTO public."role" (id,unique_label,description) VALUES
	 ...
	 (3,'curator','User that can be associated with domans and modify them.'),
	 (4,'user','A user that can generate workflows, browse history of generated workflows and upload and visualise benchmarking results');
...
INSERT INTO public.topic_of_research (id,unique_label,description,permission_id_required) VALUES
	 ...
	 (6,'proteomics',NULL,5),
	 (3,'official','A tag that only administrators are allowed to add to a repository.',6);
